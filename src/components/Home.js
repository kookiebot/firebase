    ...
    return (
      ...
      <div class="section full-height over-hide background-whiteglass-2">
        ...
        <li class="case-study-name" id="caseStudy1" onMouseOver={mouseProject1} >
					<span >The Buzz</span> <a href="/project-1" class="cursor-link animsition-link">explore</a>
				</li>
				<li class="case-study-name" id="caseStudy2" onMouseOver={mouseProject2}>
					<span>Intersec</span> <a href="/project-2" class="cursor-link animsition-link">explore</a>
				</li>
				<li class="case-study-name" id="caseStudy3" onMouseOver={mouseProject3}>
					<span>Volunteer365</span> <a href="/project-3" class="cursor-link animsition-link">explore</a>
				</li>
				<li class="case-study-name" id="caseStudy4" onMouseOver={mouseProject4}>
					<span>Superhero Portal</span><a href="/project-4" class="cursor-link animsition-link">explore</a>
				</li>
				<li class="case-study-name" id="caseStudy5" onMouseOver={mouseProject5}>
					<span>Maxicare Locator</span><a href="/project-5" class="cursor-link animsition-link">explore</a>
				</li>
				<li class="case-study-name" id="caseStudy6" onMouseOver={mouseProject6}>
					<span>People in Art</span> <a href="/project-6" class="cursor-link animsition-link">explore</a>
				</li>
			</ul>
